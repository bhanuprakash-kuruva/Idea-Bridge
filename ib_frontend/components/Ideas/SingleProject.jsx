...
const SingleProject = () => {
  ...
  useEffect(() => {
    const fetchProject = async () => {
      try {
        const { data } = await axios.get(`${import.meta.env.VITE_BASE_URL}/api/project/${id}`);
        setProject(data);
        setLoading(false);
      } catch (error) {
                            ...
                            <Avatar
                              src={
                                doc.uploadedBy.profilePicture
                                  ? `import.meta.env.VITE_BASE_URL/uploads/${doc.uploadedBy.profilePicture}`
                                  : "/default-avatar.png"
                              }
                          ...
                          <Button
                            ...
                            href={
                              doc.fileUrl.startsWith("http")
                                ? doc.fileUrl
                                : `import.meta.env.VITE_BASE_URL${doc.fileUrl}`
                            }
                            target="_blank"
