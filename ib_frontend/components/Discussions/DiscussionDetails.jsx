...
//         try {
//             await axios.post(
//                 `import.meta.env.VITE_BASE_URL/api/discussion/comments/${commentId}/reply`,
...
//                 `import.meta.env.VITE_BASE_URL/api/discussion/${id}`,
//                 { headers: authHeader }
//             );
//             setDiscussion(data);
//             setError(null);
...
//         try {
//             await axios.post(
//                 `import.meta.env.VITE_BASE_URL/api/discussion/${id}/comments`,
